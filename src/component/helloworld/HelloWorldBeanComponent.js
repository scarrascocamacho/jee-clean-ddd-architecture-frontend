...
import HelloWorldService from '../../service/helloworld/HelloWorldService';
...
class HelloWorldBeanComponent extends Component {
    ...
    render() {
        return (<>
            ...
            <div className="row">
                <button className="btn btn-success" onClick={this.gotoStringComponent}>Go String Component</button>
            </div>
        </>
        )
    }
